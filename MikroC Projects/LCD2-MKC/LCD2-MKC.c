...
void main() 
{
  ...
  Lcd_Out(1,6,txt3);                 // Escreve texto na posição: linha=1,coluna=6
  Delay_ms(4000);
  Lcd_Out(2,6,txt4);                 // Escreve texto na posição: linha=2,coluna=6
  ...
  Delay_ms(4000);
  Lcd_Out(2,5,txt2);                 // Escreve texto na posição: linha=2,coluna=5
